import { displayJackets } from "./functions.js";
const prod = document.querySelector(".products-list");
const urlString = window.location.search;
const urlParams = new URLSearchParams(urlString);
const gen = urlParams.get("gender");
let urlJackets = "https://myprojects.digital/RainyDays//wp-json/wc/store/products";

if (gen === "male") {
	urlJackets += "?category=19";
} else if (gen === "female") {
	urlJackets += "?category=20";
}
